export class Engine {
  ...
  stop(time) {
    ...
    this.env.gain.linearRampToValueAtTime(this.env.gain.value, time);
    this.env2.gain.linearRampToValueAtTime(this.env2.gain.value, time);

    this.env.gain.linearRampToValueAtTime(0, time + 0.05);
    this.env2.gain.linearRampToValueAtTime(0, time + 0.05);
